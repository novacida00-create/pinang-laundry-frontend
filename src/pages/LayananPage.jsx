...
const services = [
  { icon: "👕", name: "Cuci Kiloan", price: "Rp 6.000", unit: "/kg", waktu: "24 jam", desc: "Cuci berdasarkan berat, cocok untuk baju harian. Paket lengkap meliputi cuci, rendam, dan bilas hingga bersih." },
  { icon: "👔", name: "Cuci Satuan", price: "Rp 15.000", unit: "/pcs", waktu: "12 jam", desc: "Cuci per item, cocok untuk jas, gaun, rok dan pakaian khusus yang memerlukan penanganan khusus." },
  { icon: "⚡", name: "Express", price: "Rp 15.000", unit: "/kg", waktu: "4 jam", desc: "Layanan kilat! Laundry selesai dalam 4 jam saja. Cocok untuk kebutuhan mendesak." },
  { icon: "🧶", name: "Cuci Karpet", price: "Rp 50.000", unit: "/pcs", waktu: "48 jam", desc: "Cuci karpet besar dan tebal. Proses deep cleaning untuk karpet kesayangan Anda." },
  { icon: "🧥", name: "Cuci Jaket", price: "Rp 12.000", unit: "/pcs", waktu: "24 jam", desc: "Cuci jaket dan outerwear. Termasuk обработка khusus untuk материалу." },
  { icon: "👔", name: "Cuci Jas", price: "Rp 35.000", unit: "/pcs", waktu: "48 jam", desc: "Cuci jas profesional dengan dry clean khusus. Hasil rapi dan wangi." },
  { icon: "🔥", name: "Setrika Saja", price: "Rp 5.000", unit: "/kg", waktu: "6 jam", desc: "Hanya setrika, tanpa cucian. Pakaian Anda akan rapi seperti disetrika profesional." },
];
